...
const edu= [["b.tech -software engineering","srm university","2018","9.1 (cgpa)"],
...
const Experience = () => (
    <div><br/>
    <h1 className="subtitle">Experience Details</h1><br/>
